...
feat_output_directory = '/gpfs/milgram/project/gee_dylan/candlab/analyses/sc/pre_diss_3_18/level_1/'
...
#SBATCH --output=%(output_directory)sslurm.feat_%(subject_id)s.%%j.log
#SBATCH --error=%(output_directory)sslurm.%%x.%%j.log
