...
import sys, os
from psychopy import locale_setup, gui, visual, core, event
from psychopy.hardware.emulator import launchScan

# settings for launchScan:
MR_settings = {
    'TR': .800,     # duration (sec) per whole-brain volume
...
win = visual.Window(size=(screen_width, screen_height), fullscr=True, allowGUI=True, useFBO=True, monitor = 'testMonitor')
