...
balloon_game_info = {
	...
	'Script':"%s/MagicGame.py" % source_dir,
}
...
game_options = (balloon_game_info)


print "All right, we're playing the Balloon Game!"
...
script_with_args = python_bin + " '%s' --participant-id=%s --game-type=%s --output=%s  --version=%s %s" %(balloon_game_info['Script'], participant_id, game_type, output_directory, version, test_options)
